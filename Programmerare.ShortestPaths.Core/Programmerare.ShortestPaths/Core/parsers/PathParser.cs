...
/// Example:  "13 A B D"
/// The simple representation (without weight information) is the reason why the list of edges is also needed,
...
public sealed class PathParser<P, E, V, W>
    ...
    private readonly PathFactory<P, E, V, W> pathFactory;
    ...
    public P FromStringToPath(string pathString) {
        ...
        return CreatePath(weight, edges);
    }
