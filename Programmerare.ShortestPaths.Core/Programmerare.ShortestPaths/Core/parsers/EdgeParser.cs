...
public sealed class EdgeParser<E, V, W>
    ...
    private readonly EdgeFactory<E, V, W> edgeFactory;
    ...
    /// </summary>
    private readonly string separatorBetweenEdgesAndWeightWhenSplitting;
    private readonly string separatorBetweenEdgesAndWeightWhenCreating;
    ...
    public E FromStringToEdge(string stringRepresentationOfEdge) {
        ...
        return CreateEdge(startVertexId, endVertexId, weightValue);
    }
    ...
    /// Then we can convert the edges to string format with this method and write them to a file,
