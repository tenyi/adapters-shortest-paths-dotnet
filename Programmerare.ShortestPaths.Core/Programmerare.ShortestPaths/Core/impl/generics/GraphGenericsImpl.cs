...
public class GraphGenericsImpl<E, V, W> : GraphGenerics<E, V, W>
    ...
    private IDictionary<string, V>? mapWithVertices; // lazy loaded at the same time some the list is populated
    ...
    public static GraphGenerics<E, V, W> CreateGraphGenerics<E, V, W>(
        ...
        where V : Vertex
        where W : Weight {
        return new GraphGenericsImpl<E, V, W>(edges, graphEdgesValidationDesired);
    }
